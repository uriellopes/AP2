...
exec: main.cpp
	g++ -std=c++11 -Wall -pedantic -g -O0 -o exec main.cpp concessionaria.cpp propriedade.cpp chassi.cpp veiculo.cpp tempo.cpp
...
# OBJS = $(FILE_OBJ)main.o $(FILE_OBJ)concessionaria.o $(FILE_OBJ)propriedade.o $(FILE_OBJ)chassi.o $(FILE_OBJ)veiculos.o $(FILE_OBJ)tempo.o
